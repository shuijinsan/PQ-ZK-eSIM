...
Both outcomes are generated by the actual C verifier path. The smoke test uses synthetic protocol state and a simulated successful biometric gate; it does not exercise a real biometric matcher, the Android frontend, or the external network backend.
