...
- 5 个 claim（对应论文 Figure 4/5/6/7/8）；
...
| claim2_security_estimation | （外部 lattice-estimator，documented result，无 run.sh） | — |
| claim3_dos_early_reject | `bash claims/claim3_dos_early_reject/run.sh` | ~1 min |
| claim4_sliding_window | `bash claims/claim4_sliding_window/run.sh --quick` | ~1-2 min |
| claim5_sparse_noise | `bash claims/claim5_sparse_noise/run.sh --quick` | ~1-2 min |
